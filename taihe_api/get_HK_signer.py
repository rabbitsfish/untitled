import requests
url = 'http://dl-music.3gtest2.gionee.com/api/artist/hotList?region=HK&gender=&page=-1&pageSize=-1&api_sign=edcedcef601e8bec8d1d76c74714e14e&api_key=2e69439ca6c628c7fba819c3005fa96a&userId=0293C10C9F123F29B3C200318F091C1D&model=GIONEE%20M7&appVer=5.3.6.c&verCode=2026536002'
data =  {
    "app": {
        "appName": "音乐",
