...
if __name__ == '__main__':
    pass
    # get_request_api_sign(get_request_parmes('sysvs=5.1.16&imei=008600211651046&app_ver=5.5.6&version=1564390229&nettype=4&api_key=9dac6633be895da152187b9c1a5c0042&api_sign=a74263c203dfb7c7b7632b38623b7d0c&sdk_ver=1.0&model=M7&andorid=25'))
    # get_request_parmes(
    ...
    # keys_normal_li = ['api_key', 'imei', 'model', 'city', 'app_ver', 'sdk_ver', 'version', 'sysvs', 'nettype', 'ver',
    #                   'andorid']
